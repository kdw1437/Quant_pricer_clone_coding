...
/**
 * <p>InstrumentDetailType에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * <p>
 * <pre>
 * &lt;simpleType name="InstrumentDetailType"&gt;
 *   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string"&gt;
 *     &lt;enumeration value="ConvertibleBond"/&gt;
 *     &lt;enumeration value="BondWithWarrant"/&gt;
 ...
 * 
 */
@XmlType(name = "InstrumentDetailType")
@XmlEnum
public enum InstrumentDetailType {

    @XmlEnumValue("ConvertibleBond")
    CONVERTIBLE_BOND("ConvertibleBond"),
    @XmlEnumValue("BondWithWarrant")
    BOND_WITH_WARRANT("BondWithWarrant"),
    ...
    public static InstrumentDetailType fromValue(String v) {
        for (InstrumentDetailType c: InstrumentDetailType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
