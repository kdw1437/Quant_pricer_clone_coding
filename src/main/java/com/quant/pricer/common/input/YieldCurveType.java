...
/**
 * <p>YieldCurveType에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * <p>
 * <pre>
 * &lt;simpleType name="YieldCurveType"&gt;
...
public enum YieldCurveType {
    ...
    public static YieldCurveType fromValue(String v) {
        for (YieldCurveType c: YieldCurveType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
