...
/**
 * <p>CalculationType에 대한 Java 클래스입니다.
 * 
 ...
 *     &lt;enumeration value="Price_Greek"/&gt;
 *     &lt;enumeration value="Price_CF"/&gt;
 *     &lt;enumeration value="Price_Greek_CF"/&gt;
 *   &lt;/restriction&gt;
 * &lt;/simpleType&gt;
 * </pre>
 * 
...
public enum CalculationType {
    ...
    @XmlEnumValue("Price")
    PRICE("Price"),
    @XmlEnumValue("Price_Greek")
    PRICE_GREEK("Price_Greek"),
    @XmlEnumValue("Price_CF")
    PRICE_CF("Price_CF"),
    @XmlEnumValue("Price_Greek_CF")
    PRICE_GREEK_CF("Price_Greek_CF");
