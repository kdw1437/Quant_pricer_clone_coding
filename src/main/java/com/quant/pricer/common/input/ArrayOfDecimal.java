...
/**
 * <p>ArrayOfDecimal complex type에 대한 Java 클래스입니다.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Strike" type="{http://www.w3.org/2001/XMLSchema}decimal" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ArrayOfDecimal {
    ...
    protected List<BigDecimal> strike;
    ...
    public List<BigDecimal> getStrike() {
        if (strike == null) {
            strike = new ArrayList<BigDecimal>();
        }
        return this.strike;
    }
