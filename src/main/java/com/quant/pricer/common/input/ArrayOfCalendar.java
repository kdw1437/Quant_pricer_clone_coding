...
/**
 * <p>ArrayOfCalendar complex type에 대한 Java 클래스입니다.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Calendar" type="{}Calendar" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ArrayOfCalendar", propOrder = {
    "calendar"
})
public class ArrayOfCalendar {

    @XmlElement(name = "Calendar", nillable = true)
